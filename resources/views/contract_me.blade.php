			...
			<div class="row">
				<div class="col-lg-6">
					<div class="skillbar">
						...
						<!-- <a class="scrl-down nav-link" href="#contact">Contact us</a> -->
                        <a href="#contact" class="btn skill-btn">contact me</a>
					</div>
				</div>
				<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="contact-left">
						...
						<div class="contact-address color:white">
							<p>122 33rd Street East<br/> Saskatoon, SK<br/> S7K 1R9</p>
						</div>

						<div class="contact-mail">
							<p><span>Email:</span>alam15-6160@gmail.com</p>
							<p><span>Phone:</span>01303-531296</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
...
<script src="{{asset('assets/js/isotope.pkgd-3.0.4.min.js')}}"></script>
<script src="{{asset('assets/js/masonry.pkgd.min-4.2.0.js')}}"></script>
